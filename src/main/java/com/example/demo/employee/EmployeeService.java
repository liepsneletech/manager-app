...
public class EmployeeService {
	...
	@Transactional
	public void updateEmployee(Long employeeId, String name, Long department_id, Long project_id, String role,
			Double salary) {
		...
		if (department_id != null && !Objects.equals(employee.getDepartment_id(), department_id)) {
